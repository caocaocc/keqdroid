...
class ConnectionsSnapshot {
  ...
  /// false — владельца соединения определить нечем: в записи не оказалось
  /// исходного сокета, а без него спрашивать систему не о чем. Честнее сказать
  /// об этом, чем показывать пустую колонку.
